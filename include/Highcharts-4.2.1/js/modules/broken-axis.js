(function (e) {
            ...
            this.setAxisTranslation = function (c) {
                ...
                for (n in a) {
                    ...
                    for (; i < l; i += k)c.push({value: i, move: "in"}), c.push({
                        value: i +
                        (g.to - g.from), move: "out", size: g.breakSize
                    })
                }
                c.sort(function (a, c) {
    ...
    o(w.prototype, "generatePoints", function (d) {
        ...
        var e = this.xAxis, a = this.yAxis,
            b = this.points, c, f = b.length, j = this.options.connectNulls, m;
    ...
    e.Series.prototype.drawBreaks = function () {
        ...
        r(["y", "x"], function (m) {
            ...
            r(e, function (d) {
                ...
                r(b, function (b) {
                    f = !1;
                    if (c < b.from && j > b.to || c > b.from && j < b.from)f = "pointBreak"; else if (c < b.from && j > b.from && j < b.to || c > b.from && j > b.to && j < b.from)f = "pointInBreak";
