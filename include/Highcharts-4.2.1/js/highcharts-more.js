...
(function (n) {
    ...
    B = {
        ...
        translate: function () {
            ...
            s(this.points, function (f) {
                ...
                f.shapeType = "path";
                f.shapeArgs = {
                    d: e.path || ["M", -j, -m / 2, "L", h, -m / 2, d, -g / 2, d, g / 2, h, m / 2, -j, m / 2, "z"],
                    translateX: c[0],
                    translateY: c[1],
                    rotation: k
                };
        ...
        drawPoints: function () {
            ...
            c ? c.animate({
                translateX: b[0],
                translateY: b[1]
            }) : a.pivot = d.circle(0, 0, o(e.radius, 5)).attr({
    ...
    (function () {
        ...
        function b(a, b) {
            ...
            if (c.polar) {
                if (c.renderer.isSVG)f === !0 && (f = {}), b ? (c = {
                    translateX: k[0] + i,
                    translateY: k[1] + n,
                    scaleX: 0.001,
                    scaleY: 0.001
                }, g.attr(c), e && e.attr(c)) : (c = {
                    translateX: i,
                    translateY: n,
                    scaleX: 1,
                    scaleY: 1
        ...
        r(f, "getCoordinates", function (a, b) {
            ...
            c.polar ? s(c.axes, function (a) {
                ...
                f[d ? "xAxis" : "yAxis"].push({
                    axis: a,
                    value: a.translate(d ? Math.PI - Math.atan2(i, e) : Math.sqrt(Math.pow(i, 2) + Math.pow(e, 2)), !0)
                })
            }) : f = a.call(this, b);
            return f
        })
